...
export const spinnerVariants = cva('animate-spin', {
  variants: {
    ...
    variant: {
      default: 'text-primary/20 fill-primary',
      secondary: 'text-secondary/20 fill-secondary',
      muted: 'text-muted-foreground/20 fill-muted-foreground',
      destructive: 'text-destructive/20 fill-destructive',
      success: 'text-green-600/20 fill-green-600',
      warning: 'text-yellow-600/20 fill-yellow-600',
      info: 'text-blue-600/20 fill-blue-600',
    },
  },
  defaultVariants: {
    size: 'md',
...
/**
 * Spinner component with customizable size, color variants, and accessibility features.
 *
 * @example
 * ```tsx
 * // Basic usage
